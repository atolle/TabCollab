        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActingUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TabVersions", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TabVersions_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TabData = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TabFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TabFiles_TabVersions_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Friends_AspNetUsers_ActingUserId",
                table: "Friends",
                column: "ActingUserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
